...
"""Implementation-neutral JSON TCK loader and reference adapter.
...
class CommitTckAdapter(Protocol):
    def evaluate(self, vector: CommitTckVector) -> Mapping[str, Any]: ...
...
class ReferenceCommitTckAdapter:
    ...
    def __init__(self) -> None:
        self._operations: dict[
            str, Callable[[CommitTckVector], dict[str, Any]]
        ] = {
    ...
    def evaluate(self, vector: CommitTckVector) -> Mapping[str, Any]:
        operation = vector.inputs.get("operation")
        if not isinstance(operation, str) or operation not in self._operations:
            raise ValueError(
                f"TCK vector {vector.id} uses unsupported operation: {operation!r}"
            )
        actual = _json_result(self._operations[operation](vector))
        _validate_expected_shape(actual, label=f"actual result for {vector.id}")
        return actual

    def _canonical_fingerprint(self, vector: CommitTckVector) -> dict[str, Any]:
    ...
    def _canonical_set_fingerprint(self, vector: CommitTckVector) -> dict[str, Any]:
    ...
    def _fixed_point_multiply(self, vector: CommitTckVector) -> dict[str, Any]:
    ...
    def _fixed_point_ratio(self, vector: CommitTckVector) -> dict[str, Any]:
    ...
    def _manifest_validation(self, vector: CommitTckVector) -> dict[str, Any]:
    ...
    def _terminal_priority(self, vector: CommitTckVector) -> dict[str, Any]:
    ...
    def _trace_replay(self, vector: CommitTckVector) -> dict[str, Any]:
    ...
    def _matrix_case(self, vector: CommitTckVector) -> dict[str, Any]:
...
def _require_vector_manifest(vector: CommitTckVector) -> dict[str, Any]:
    if vector.manifest is None:
...
def _probe_case_01(vector: CommitTckVector) -> dict[str, Any]:
...
def _probe_case_02(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector)
...
def _probe_case_03(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector)
...
def _probe_case_04(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector)
    counter = _observation(
        scenario,
        index=401,
...
def _probe_case_05(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector)
    observations = tuple(
        _observation(
            scenario,
...
def _probe_case_06(vector: CommitTckVector) -> dict[str, Any]:
...
def _probe_case_07(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector)
    leader_leases = tuple(
...
def _probe_case_08(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector, shared_cluster=True)
    evaluation = evaluate_support_leases(
        scenario.leases,
        revocations=(),
...
def _probe_case_09(vector: CommitTckVector) -> dict[str, Any]:
...
def _probe_case_10(vector: CommitTckVector) -> dict[str, Any]:
...
def _probe_case_11(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector)
...
def _probe_case_12(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector)
    window = _initialize_window(scenario)
...
def _probe_case_13(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector)
...
def _probe_case_14(vector: CommitTckVector) -> dict[str, Any]:
    # Gate failure.
...
def _probe_case_15(vector: CommitTckVector) -> dict[str, Any]:
...
def _probe_case_16(vector: CommitTckVector) -> dict[str, Any]:
...
def _probe_case_17(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector)
...
def _probe_case_18(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector)
...
def _probe_case_19(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector)
...
def _probe_case_20(vector: CommitTckVector) -> dict[str, Any]:
    manifest = _require_vector_manifest(vector)
    deadline_kind = _text(
...
def _probe_case_21(vector: CommitTckVector) -> dict[str, Any]:
...
def _probe_case_22(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector)
...
def _probe_case_23(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector)
...
def _probe_case_24(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector)
...
def _probe_case_25(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector)
...
def _probe_case_26(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector)
...
def _probe_case_27(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector)
...
def _probe_case_28(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector)
...
def _probe_case_29(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector)
...
def _probe_case_30(vector: CommitTckVector) -> dict[str, Any]:
    (
        bundle,
        first,
        same_value_retry,
...
def _probe_case_31(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector)
...
def _probe_case_32(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector)
...
def _probe_case_33(vector: CommitTckVector) -> dict[str, Any]:
...
def _probe_case_34(vector: CommitTckVector) -> dict[str, Any]:
    scenario = _reference_scenario(vector)
...
def _probe_case_35(vector: CommitTckVector) -> dict[str, Any]:
    # Lazy by design: runner imports checks, which lazily import this TCK.
    from pheroos.conformance.runner import MANIFEST_CHECKS

    manifest = capability_manifest_from_dict(_require_vector_manifest(vector))
    profile = profile_for_manifest(manifest)
    required = tuple(profile.required_checks)
    registered = tuple(
        name
        for name in required
        if name == "manifest_schema" or callable(MANIFEST_CHECKS.get(name))
    )
...
def _probe_case_36(vector: CommitTckVector) -> dict[str, Any]:
...
def _probe_case_37(vector: CommitTckVector) -> dict[str, Any]:
    manifest = capability_manifest_from_dict(_require_vector_manifest(vector))
    profile = profile_for_manifest(manifest)
...
def _probe_case_38(vector: CommitTckVector) -> dict[str, Any]:
    del vector
...
_MATRIX_PROBES: dict[int, Callable[[CommitTckVector], dict[str, Any]]] = {
    1: _probe_case_01,
    2: _probe_case_02,
    3: _probe_case_03,
    4: _probe_case_04,
...
def load_commit_tck_vectors(
    ...
    if cases != tuple(range(1, 39)):
        raise ValueError(
            "commit TCK artifact must contain matrix cases 1..38 in order"
        )
    return vectors


def commit_tck_artifact_root(
    path: str | Path | Any = None,
) -> str:
...
def commit_tck_schema() -> dict[str, Any]:
    expected = {
        "type": "object",
        "required": sorted(_EXPECTED_FIELDS),
    ...
    vector = {
        "type": "object",
        "required": sorted(_VECTOR_FIELDS),
        "additionalProperties": False,
        "properties": {
            "id": {"type": "string", "minLength": 1},
...
def run_commit_tck(
    ...
    *,
    ...
    implementation = adapter or ReferenceCommitTckAdapter()
    ...
    for vector in selected:
        ...
        for mutation in vector.mutations:
            mutated = _variant_vector(vector, mutation, permutation=False)
        ...
        for permutation in vector.permutations:
            permuted = _variant_vector(vector, permutation, permutation=True)
            ...
            repeated_permutation = _evaluate_adapter(
                implementation,
                permuted,
            )
...
def _vector_from_json(raw: object) -> CommitTckVector:
    value = _object(raw, "commit TCK vector")
    if set(value) != _VECTOR_FIELDS:
        missing = sorted(_VECTOR_FIELDS - set(value))
        unknown = sorted(set(value) - _VECTOR_FIELDS)
        raise ValueError(
            "commit TCK vector fields are invalid: "
            f"missing={missing}, unknown={unknown}"
        )
    expected = _object(value["expected"], "commit TCK expected")
    _validate_expected_shape(expected, label="commit TCK expected")
    mutations = _validate_variants(value["mutations"], permutation=False)
    permutations = _validate_variants(value["permutations"], permutation=True)
    variant_ids = tuple(
        item["id"] for item in (*mutations, *permutations)
    )
    if len(variant_ids) != len(set(variant_ids)):
        raise ValueError("commit TCK vector contains duplicate variant ids")
    matrix_case = _integer(value["matrix_case"], "commit TCK matrix_case")
    if matrix_case <= 0:
        raise ValueError("commit TCK matrix_case must be positive")
    tck_version = _text(value["tck_version"], "commit TCK version")
    ...
    return CommitTckVector(
        id=_text(value["id"], "commit TCK vector id"),
        tck_version=tck_version,
        matrix_case=matrix_case,
        title=_text(value["title"], "commit TCK vector title"),
        manifest=deepcopy(manifest),
        profile=_text(value["profile"], "commit TCK vector profile"),
        ...
        inputs=deepcopy(_object(value["inputs"], "commit TCK inputs")),
...
def _evaluate_adapter(
    ...
    try:
        actual = _json_result(dict(adapter.evaluate(vector)))
        _validate_expected_shape(actual, label=f"actual result for {vector.id}")
        return actual
    except Exception as exc:
        return _result(failure_code=f"exception:{type(exc).__name__}:{exc}")


def _json_result(value: Mapping[str, Any]) -> dict[str, Any]:
    """Project an adapter result onto the JSON TCK value model.

    Public ABI payload helpers may expose immutable tuples for in-process
    callers.  JSON arrays have no tuple/list distinction, so exact TCK
    comparison must happen after the same JSON projection used by the checked
    artifact, while still rejecting non-JSON values and non-finite numbers.
    """
...
def _validate_variants(value: object, *, permutation: bool) -> list[dict[str, Any]]:
    ...
    for index, raw in enumerate(value):
        ...
        _text(raw["id"], f"commit TCK {label}[{index}] id")
        ...
        expected = _object(raw["expected"], f"commit TCK {label}[{index}] expected")
    ...
    if permutation:
        ...
        if order == "reverse":
            ...
            if sorted(order) != list(range(len(current))):
                raise ValueError("commit TCK permutation order must be a full bijection")
...
def _validate_expected_shape(value: Mapping[str, Any], *, label: str) -> None:
