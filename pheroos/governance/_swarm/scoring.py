...
from pheroos.governance._swarm.signals import InhibitionSignal, RecruitmentSignal, ScoutReport, require_finite_non_negative, validate_collective_signal, validate_scout_report
...
for _compat_function in (score_candidates, merge_candidate_breakdown, validate_score_breakdown, candidate_score_lineage,):
    _compat_function.__module__ = 'pheroos.governance.collective'
del _compat_function

__all__ = ('candidate_score_lineage', 'merge_candidate_breakdown', 'score_candidates', 'validate_score_breakdown')
