...
for _compat_function in (validate_scout_report, validate_collective_signal, require_finite_non_negative, require_finite_bounded_strength,):
    _compat_function.__module__ = 'pheroos.governance.collective'
del _compat_function
for _compat_type in (ScoutReport, RecruitmentSignal, InhibitionSignal,):
...
__all__ = ('InhibitionSignal', 'RecruitmentSignal', 'ScoutReport', 'require_finite_bounded_strength', 'require_finite_non_negative', 'validate_collective_signal', 'validate_scout_report')
