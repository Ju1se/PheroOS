"""Public Draft ABI for target-scoped durable Commit Replay v2.

Portable receipts and source preparation attest deterministic replay
bookkeeping only; they do not establish upstream evidence authority.  Durable
authority requires the exact ADVANCE_REPLAY session and atomic StateStore v2
commit performed by :func:`advance_commit_replay_state_v2`.
"""
