...
PREDECESSOR_EXPORT_ORDER_SHA256 = (
    "2979b47c37f629a0f70ba6bffeca8fe7329ce144cb16c464596961e0dd877100"
)
EXPECTED_EXPORT_ORDER_SHA256 = (
    "bc2cf49d2b6e68807ecddc3eef11491e0299b5157859ae999c781305c8eb51c4"
)
REMOVED_EXPORTS = frozenset(
    {
        "commit_replay_receipt_v2_from_v1",
...
# D-06: the v1 process-local authority cohort has no external issuers.  Its
# implementation remains available only to internal migration code; no new
# consumer can bind these deprecated names through the public facade.
REMOVED_EXPORTS = REMOVED_EXPORTS | frozenset(
    {
...
# The attention evaluator is retained as a private implementation profile, not
# as a root Governance ABI surface.
REMOVED_EXPORTS = REMOVED_EXPORTS | frozenset(
    {
